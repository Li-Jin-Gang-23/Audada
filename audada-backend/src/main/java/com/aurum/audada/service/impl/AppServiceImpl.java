...
import com.aurum.audada.mapper.AppMapper;
import com.aurum.audada.model.dto.app.AppQueryRequest;
...
import com.aurum.audada.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appScoringStrategyEnum == null, ErrorCode.PARAMS_ERROR, "应用评分策略不正确");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
