...
import com.aurum.audada.mapper.ScoringResultMapper;
import com.aurum.audada.model.dto.scoringResult.ScoringResultQueryRequest;
...
import com.aurum.audada.model.vo.ScoringResultVO;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public QueryWrapper<ScoringResult> getQueryWrapper(ScoringResultQueryRequest scoringResultQueryRequest) {
        ...
        queryWrapper.ne(StringUtils.isNotBlank(resultPicture), "resultPicture", resultPicture);
        // 排序规则
